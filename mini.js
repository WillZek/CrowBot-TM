...
mobile: MethodMobile, 
browser: opcion == '1' ? ['CrowBot-MD', 'Edge', '2.0.0'] : methodCodeQR ? ['CrowBot-MD', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
console.log(chalk.black(chalk.bgGreen(`🌟 CÓDIGO DE INICIO:`)), chalk.bold.white(chalk.white(codeBot)))
}, 2000)
}}}
}
...
console.log('🌟 CrowBot-MD no tiene Sub-Bots vinculados.');
return;
}
...
console.log(chalk.bold.greenBright(`⭐ CrowBot-MD conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`⭐ Error al iniciar CrowBot-MD: `, error))
}
})();*/
